...
export const HERO_BADGE_WITH_TIMING = "ChatGPT Plus · 3–5 минут · Оплата в ₽ · Работает в России";
export const HERO_BADGE_NO_TIMING = "ChatGPT Plus · Оплата в ₽ · Работает в России";
export const HERO_ACCENT_BASE = "без иностранной карты";
export const HERO_ACCENT_WITH_TIMING = "без иностранной карты — подключим за 3–5 минут";
...
export const HERO_CONTENT: HeroContent = {
  ...
  subtitle:
    "Подключаем подписку ChatGPT на ваш аккаунт. Оплата в рублях, статус заказа в кабинете, поддержка на связи.",
  trustBadges: [
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  {
    ...
    description: "Plus или Pro — выберите формат подключения под вашу задачу.",
    icon: "credit-card",
  },
  {
    title: "Оплатите заказ в рублях",
    description: "Картой РФ, СБП или через Pally — без иностранной карты.",
    icon: "mail",
  },
  {
    title: "Следите за статусом в кабинете",
    description:
      "После оплаты откройте личный кабинет — там видны этапы заказа и чат с оператором.",
    icon: "sparkles",
  },
  {
    title: "Оператор подключит подписку",
    description:
      "Подключаем Plus на ваш аккаунт. Если нужно подтверждение — подскажем безопасный способ.",
    icon: "rocket",
  },
  {
    title: "Пользуйтесь ChatGPT Plus / Pro",
    description: "Доступ активируется по выбранному тарифу — с гарантией на весь срок.",
    icon: "check-circle-2",
  },
];
...
export const WHY_CHEAPER_POINTS = [
  ...
  "Вы получаете подписку ChatGPT Plus на свой аккаунт — с выбором обычной очереди или быстрой активации.",
];
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "«Популярный» — подключение на ваш аккаунт в общей очереди. «Быстрая активация» — тот же Plus, но вне очереди, обычно 5–15 минут после передачи данных.",
  },
  {
