...
export const HERO_PROMO_CONFIG: Record<HeroPromoSiteKey, HeroPromoSiteConfig> = {
  ...
  spotify: {
    ...
    discountLabel: "Скидка 90 ₽",
    fallbackDiscountPercent: 20,
    savingsRub: 90,
    window: SEPTEMBER_2026,
    deadline: SEPTEMBER_2026.end,
    promoTitle: "Скидка 90 ₽ · до 31 сентября",
    periodBadge: "1–31 сентября",
    offerHeadline: "Готовый Premium с новым аккаунтом — если не нужен текущий профиль.",
    offerSubline: null,
    monthlyHint: null,
    terms: [
      "Акция действует с 1 по 31 сентября 2026 года (по московскому времени).",
      "Указанная на карточке цена уже итоговая — дополнительные 90 ₽ автоматически не вычитаются.",
