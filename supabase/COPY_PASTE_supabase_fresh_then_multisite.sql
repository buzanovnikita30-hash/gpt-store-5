...
-- Если таблицы УЖЕ есть: НЕ запускайте целиком — выполняйте отдельные файлы
--   migrations/001, 002, 003 или только 009, иначе будут ошибки «already exists».
-- =============================================================================

-- ##############################################################################
-- ## ЧАСТЬ 1 из 001_initial_schema.sql
-- ##############################################################################
...
-- Старая БД: orders уже есть без части колонок — CREATE TABLE IF NOT EXISTS её не обновляет.
...
-- ##############################################################################
-- ## ЧАСТЬ 2 из 002_chat_sender_admin_and_staff_sessions.sql
-- ##############################################################################
...
-- Участники внутреннего чата staff
...
-- ##############################################################################
-- ## ЧАСТЬ 3 из 003_promocodes_discounts_client_stage.sql
-- ##############################################################################
...
-- ##############################################################################
-- ## ЧАСТЬ 4 из 009_subs_store_final.sql (мультисайт)
-- ##############################################################################
...
-- =============================================================================
-- Готово. Проверка (можно отдельным запуском):
